...
export const works: WorkItem[] = [
  ...
  },
  {
    ...
    description: "Gamic is a modern community platform that blends social networking, community building, and Web3 technology into a privacy-first experience. Designed to give users greater control over their online presence, it provides the tools needed to connect, engage, and grow communities in a secure and decentralized environment. My role involved designing custom illustrations and marketing visuals for social media campaigns and product integrations. Through illustration and visual storytelling, I helped communicate Gamic's vision, simplify complex concepts, and create a cohesive brand experience across multiple digital touchpoints.",
    tags: ["Community", "Social", "Web3", "Privacy"],
    tooltip: "/Images/gamic tooltip.png",
    details: {
      intro: "Gamic is a modern community platform that blends social networking, community building, and Web3 technology into a privacy-first experience. Designed to give users greater control over their online presence, it provides the tools needed to connect, engage, and grow communities in a secure and decentralized environment.\n\nMy role involved designing custom illustrations and marketing visuals for social media campaigns and product integrations. Through illustration and visual storytelling, I helped communicate Gamic's vision, simplify complex concepts, and create a cohesive brand experience across multiple digital touchpoints.",
      secondaryText: "",
      heroImage: "",
      grid2Up: ["", ""] as [string, string],
      fullWidthImage1: "",
...
export const projects: ProjectItem[] = [
  {
    ...
    details: {
      ...
      illustrations: [
        { name: "Scene 1", description: "Connected to your meter, in real time.", image: "/Images/Watts up 1.mp4" },
        { name: "Scene 2", description: "Top Up Your Meter in Just a Few Steps.", image: "/Images/Watts up 2.mp4" },
        { name: "Scene 3", description: "Know Your Current Tariff and What Affects Your Rate.", image: "/Images/Watts up 3.mp4" },
        { name: "Scene 4", description: "Monitor Your Energy Usage and Stay Within Your Tariff Band.", image: "/Images/Watts up 4.mp4" }
      ]
    }
  }
];
